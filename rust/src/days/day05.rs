...
mod tests {
    ...
    fn test_poly_on_examples() {
        ...
        assert_eq!(polymerize(vec!['a', 'b', 'A', 'B']), vec!['a', 'b', 'A', 'B']);
        assert_eq!(polymerize("dabAcCaCBAcCcaDA".chars().collect()),
                   "dabCBAcaDA".chars().collect::<Vec<char>>());
        assert_eq!(polymerize("aabAAB".chars().collect()),
    ...
    fn skip_tests() {
        ...
        assert_eq!(polymerize_with_skip(&polymer, 'a'), "dbCBcD".chars().collect::<Vec<char>>());
        assert_eq!(polymerize_with_skip(&polymer, 'b'), "daCAcaDA".chars().collect::<Vec<char>>());
        assert_eq!(polymerize_with_skip(&polymer, 'c'), "daDA".chars().collect::<Vec<char>>());
        assert_eq!(polymerize_with_skip(&polymer, 'd'), "abCBAc".chars().collect::<Vec<char>>());
    }
}
